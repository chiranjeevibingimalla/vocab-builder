...
export const IconBulb: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M15.09 14.32a6.38 6.38 0 0 1-8.18-8.18"></path><path d="M12 2a7.02 7.02 0 0 1 7 7c0 3-2 5-2 5s-2-2-2-5a3 3 0 0 0-3-3a2.98 2.98 0 0 0-2.33 1.07"></path><path d="M12 22v-2"></path><path d="M12 15H8"></path><path d="M16 15h-1.5"></path></svg>
);
...
export const IconStarFilled: React.FC<IconProps> = (props) => (
